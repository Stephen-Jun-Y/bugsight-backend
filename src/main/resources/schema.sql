...
CREATE TABLE IF NOT EXISTS insect_info (
    ...
    species_name_en     VARCHAR(200) NOT NULL                COMMENT '英文学名/学名',
    order_name          VARCHAR(50)  NOT NULL                COMMENT '目（英文/拉丁）',
    order_name_cn       VARCHAR(50)                          COMMENT '目（中文）',
    family_name         VARCHAR(50)  NOT NULL                COMMENT '科（英文/拉丁）',
    family_name_cn      VARCHAR(50)                          COMMENT '科（中文）',
    genus_name          VARCHAR(50)                          COMMENT '属（英文/拉丁）',
    genus_name_cn       VARCHAR(50)                          COMMENT '属（中文）',
    body_length         VARCHAR(255)                         COMMENT '体长范围（中文）',
    body_length_en      VARCHAR(255)                         COMMENT 'Body length (EN)',
    distribution        TEXT                                 COMMENT '分布区域（中文）',
    distribution_en     TEXT                                 COMMENT 'Distribution (EN)',
    active_season       VARCHAR(255)                         COMMENT '活跃季节（中文）',
    active_season_en    VARCHAR(255)                         COMMENT 'Active season (EN)',
    protection_level    VARCHAR(100)                         COMMENT '保护等级（中文）',
    protection_level_en VARCHAR(100)                         COMMENT 'Protection level (EN)',
    harm_level          TINYINT      NOT NULL DEFAULT 0      COMMENT '0=益虫 1=无害 2=害虫',
    description         TEXT                                 COMMENT '百科介绍（中文）',
    description_en      TEXT                                 COMMENT 'Description (EN)',
    morphology          TEXT                                 COMMENT '形态特征（中文）',
    morphology_en       TEXT                                 COMMENT 'Morphology (EN)',
    habits              TEXT                                 COMMENT '生活习性（中文）',
